...
let g:colors_name = 'tokyonight-modified'
" }}}
" Configuration: {{{
let s:configuration = {}
...
if s:configuration.transparent_background
  ...
  call s:HL('Folded', s:palette.grey, s:palette.bg0)
  call s:HL('SignColumn', s:palette.fg, s:palette.bg0)
  call s:HL('ToolbarLine', s:palette.fg, s:palette.bg2)
endif
call s:HL('ColorColumn', s:palette.none, s:palette.none)
...
call s:HL('StatusLineNC', s:palette.grey, s:palette.bg0)
call s:HL('StatusLineTermNC', s:palette.grey, s:palette.bg0)
call s:HL('TabLine', s:palette.fg, s:palette.bg4)
call s:HL('TabLineFill', s:palette.grey, s:palette.bg0)
...
if s:configuration.transparent_background
  ...
  call s:HL('ALEErrorSign', s:palette.red, s:palette.bg0)
  call s:HL('ALEWarningSign', s:palette.yellow, s:palette.bg0)
  call s:HL('ALEInfoSign', s:palette.blue, s:palette.bg0)
endif
